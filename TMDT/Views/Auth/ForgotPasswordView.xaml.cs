...
namespace TMDT.Views.Auth
{
    ...
    public partial class ForgotPasswordView : Window
    {
        ...
        public ForgotPasswordView()
        {
            ...
            this.PreviewMouseMove += ForgotPasswordView_PreviewMouseMove;
            ...
            this.DataContextChanged += ForgotPasswordView_DataContextChanged;
            if (this.DataContext is ForgotPasswordViewModel vm)
            {
                vm.PropertyChanged += ViewModel_PropertyChanged;
            }
        }

        private void ForgotPasswordView_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            if (e.OldValue is ForgotPasswordViewModel oldVm)
            {
                oldVm.PropertyChanged -= ViewModel_PropertyChanged;
            }
            if (e.NewValue is ForgotPasswordViewModel newVm)
            {
        ...
        private void ViewModel_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            {
                if (e.PropertyName == nameof(ForgotPasswordViewModel.ErrorMessage))
                {
                ...
                else if (e.PropertyName == nameof(ForgotPasswordViewModel.SuccessMessage))
                {
        ...
        private void ForgotPasswordView_PreviewMouseMove(object sender, MouseEventArgs e)
        {
